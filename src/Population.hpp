...
public:
  ...
  void                            evolve_l( const ListGraph & graph, size_t tournamentSize, double crossoverRate, double elitismRate, double mutationRate );
  void                            evolve_m( const MatrixGraph & graph, size_t tournamentSize, double crossoverRate, double elitismRate, double mutationRate );
...
private:
  ...
  void                              mutation_m( Chromosome & chr, float mutationRate, const MatrixGraph & graph );
};
